# Django settings for juliobs project.
...
MEDIA_ROOT = os.path.join(SITE_ROOT, 'arquivos/media')
...
STATIC_ROOT = os.path.join(SITE_ROOT, 'arquivos/static')
...
STATICFILES_DIRS = (
    ...
    os.path.join(SITE_ROOT, 'arquivos/static_files'),
)
